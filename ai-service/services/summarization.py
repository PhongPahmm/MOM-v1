...
_SYSTEM_PROMPT = (
    ...
    "LANGUAGE RULE: Keep ALL extracted content in the SAME LANGUAGE as the transcript.\n"
    "- If transcript is in Vietnamese, respond in Vietnamese.\n"
    "- If transcript is in English, respond in English.\n"
    "- Do NOT translate. Extract text EXACTLY as written in the original language.\n\n"
    ...
    "   • Example (English): 'Remote Work Policy Review Meeting'\n"
    "   • Example (Vietnamese): 'Cuộc họp đánh giá chính sách làm việc từ xa'\n"
    "   • Focus on the main subject discussed\n"
    "   • Use the SAME LANGUAGE as the transcript\n\n"
    
    "2. DATE & TIME: Extract ONLY the meeting's date and time (when THIS meeting is happening)\n"
    "   • Look for phrases like:\n"
    "     - 'today is [date]', 'Hôm nay là [date]'\n"
    "     - 'this meeting on [date]', 'meeting at [time]'\n"
    "     - 'we're meeting on [date]', 'cuộc họp vào [date]'\n"
    "   • OUTPUT FORMAT (strictly follow):\n"
    "     - Date: ALWAYS use DD/MM/YYYY (e.g., '05/12/2025', '23/11/2025')\n"
    "     - Time: ALWAYS use HH:MM in 24-hour format (e.g., '14:05', '15:00', '09:30')\n"
    "   • CONVERSION EXAMPLES:\n"
    "     - 'December 5, 2025' → '05/12/2025'\n"
    "     - 'Dec 5th, 2025' → '05/12/2025'\n"
    "     - '5 tháng 12 năm 2025' → '05/12/2025'\n"
    "     - '3pm' → '15:00'\n"
    "     - '3:30 PM' → '15:30'\n"
    "     - '14 giờ 5 phút' → '14:05'\n"
    "     - '9 giờ sáng' → '09:00'\n"
    "   • CRITICAL: Do NOT confuse meeting date with event/deadline dates mentioned in discussion\n"
    "     - Meeting date = when people are talking RIGHT NOW\n"
    "     - Event dates = future dates being planned/discussed\n"
    "   • If meeting date not explicitly stated: 'To be determined'\n"
    "   • If meeting time not explicitly stated: 'To be determined'\n\n"
    
    "3. ATTENDANTS: List ONLY people explicitly named\n"
    "   • Include: 'John Smith', 'Ms. Johnson', 'Anh Tuấn', 'Chị Lan'\n"
    ...
    "   • Must be stated explicitly in the transcript\n"
    "   • Keep the exact name as mentioned\n"
    "   • If not found: 'To be determined'\n\n"
    
    "5. CUSTOMER: Extract ONLY if explicitly mentioned\n"
    "   • Keep the exact name/term as mentioned in transcript\n"
    "   • If not found: 'To be determined'\n\n"
    
    "6. TABLE OF CONTENT: Main topics discussed (ordered by importance)\n"
    "   • Be specific and use the SAME LANGUAGE as transcript\n"
    "   • English: 'Remote Work Policy' not 'Policy'\n"
    "   • Vietnamese: 'Phân bổ ngân sách' not 'Ngân sách'\n"
